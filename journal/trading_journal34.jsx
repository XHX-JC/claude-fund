...
const INITIAL_STATE = {
  "lastUpdated": "2026-04-19 SUPPLEMENTARY — AI THESIS SCAN + SI-48 ADDED",
  "sessionNumber": 24,
  "fund": {
    "account": "U24936508",
    "netLiquidity": 105600,
    ...
    "lastUpdated": "2026-04-19 SESSION 24 SUPPLEMENTARY — JOURNAL v34 — AI THESIS DEEP DIVE + SI-48 ADDED",
    "note": "JOURNAL v34 — SESSION 24 SUPPLEMENTARY (Sunday 19 Apr 2026). AI INFRASTRUCTURE THESIS DEEP DIVE COMPLETED. Full Stage 1 research in C:\\Users\\jcadb\\claude-fund\\research\\AI_INFRASTRUCTURE_THESIS.md (40+ candidates). Key additions: SI-48 (AI thesis ATH rule amendment — ATH alone not auto-disqualifier if Stage 2 shows upside without multiple expansion), T19 (ATH rule is thesis-dependent), T20 (Next Nvidia framing correction — seek IP/tech at modest valuation, not literal Nvidia replacement), P19 (AI thesis crowded trade observation), S12 (thesis-dedicated research files). Tier 1 Stage 2 priorities: MU (HBM supercycle, fwd PE anomaly), HPE (cheapest AI name, fwd PE 10.74, passes SI-48 at ATH), SNPS (EDA duopoly at -31% drawdown). PLTR P6 lesson remains governing guardrail — no entry on narrative/multiple expansion theses. All other session 24 state unchanged: Hormuz re-closed Sat Apr 18, NOG sell cancelled, SLV BUY cancelled (both legs), NOG has NO STOP — MUST RESUBMIT $22.50 GTC MONDAY APR 20 FIRST ACTION BEFORE 13:30 UAE."
  },
  "thesis": {
    ...
    "keyDates": [
      {"date": "19 Apr (TODAY — S24 SUPP)", "event": "SUNDAY. No markets. AI thesis deep dive completed. Journal v34 written. SI-48 added.", "priority": "RESOLVED — SUPPLEMENTARY COMPLETE"},
      {"date": "20 Apr (Mon)", "event": "NYSE opens 13:30 UAE. PRIORITY 1: Resubmit NOG stop $22.50 GTC. Confirm NOG sell + SLV BUY cancellations. Run SI-45 weekly screener. Section 0 SI-39 (now including AI Tier 2 watchlist). Begin Stage 2 on MU/HPE/SNPS.", "priority": "CRITICAL"},
      ...
      {"date": "30 Apr (Wed)", "event": "Schneider Electric (SU.PA) earnings — AI thesis Stage 2 catalyst; Prysmian (PRY.MI) earnings", "priority": "MEDIUM"},
  ...
  "positions": [
    {
      ...
      "note": "NOG sell (Market DAY) CANCELLED Sunday Apr 19 — Hormuz re-closure restores oil war premium thesis. Stop $22.50 was cancelled S23 (E9). CRITICAL: position currently has NO stop protection. MONDAY FIRST ACTION: resubmit SELL Stop $22.50 GTC before any analysis or other actions. Apr 30 Q1 earnings."
    },
    {
      ...
      "note": "291 shares. Trust $10.27 floor. Deal close ~May 2026."
    },
    {
      ...
      "note": "Nuclear thesis structural. Independent of Hormuz."
    },
    {
      ...
      "note": "Stop $234.39/$224 Stop Limit GTC. Earnings Wednesday Apr 23 AMC."
    },
    {
      ...
      "status": "HOLD — STOP LIVE",
      "note": "Stop $151.50 above cost. Earnings May 13. AI data centre power thesis intact."
    },
    {
      ...
      "status": "HARD LOCK — NO SELL BEFORE APR 23 EX-DIV", "cur": "GBP",
      "note": "EX-DIV WEDNESDAY APR 23 — ABSOLUTE HARD LOCK."
    },
    {
      ...
      "note": "2,000 shares post-S22 trim. +102% unrealised."
    },
    {
      ...
      "note": "Silicon anode battery/drone endurance thesis. Q1 earnings May 7."
    },
    {
      ...
      "status": "HOLD — STOP LIVE",
      "note": "May 13 earnings. No add until DoD contract news."
    },
    {
      ...
      "note": "Iran lost track of mines — cannot reopen without USN support. Mine clearance multi-year program regardless of political outcome."
    },
    {
      ...
      "note": "Max loss ~$158 intentional. Grandfathered above SI-37 cap."
    },
    {
      ...
      "note": "Earnings Tuesday Apr 21 AMC. Post-beat: raise stop to $455-460."
    },
    {
      ...
      "note": "Azure + Copilot thesis intact. Core AI thesis exposure."
    },
    {
      ...
      "note": "Q1 earnings May 6. €200M deferred Q4 orders must appear."
    },
    {
      ...
      "note": "GLP-1 thesis intact. Independent of Hormuz."
    },
    {
      ...
      "note": "US critical minerals strategic gap vs China. Add order $10.50 GTC active for 40 shares on pullback."
    }
  ],
  "pendingOrders": [
    {"ticker": "NOG", "action": "SELL", "type": "Stop", "qty": 80, "stopPrice": 22.50, "tif": "GTC", "status": "MUST RESUBMIT MONDAY — POSITION CURRENTLY UNPROTECTED",
     "note": "MONDAY APR 20 FIRST ACTION: resubmit $22.50 GTC stop before any other action. Max loss $166 on 80 shares."},
  ...
  "si39TierTwoAIThesisWatchlist": {
    ...
    "tier1Priorities": [
      {
        "ticker": "MU", "name": "Micron Technology", "priority": 1,
        "price": 454.20, "52wkHigh": 471.34, "drawdown": -3.6, "fwdPE": 7.86,
        "trigger": -15, "triggerPrice": 400.64,
        "thesisOneLine": "HBM memory supercycle — Q2 FY26 EPS $12.20 vs $8.42 guidance; Q3 guidance $19.15 EPS; HBM sold out through 2026",
        "nextEarnings": "2026-07-01 AMC",
        "si48Status": "PASSES scan — anomalous fwd PE, structural catalyst, no multiple expansion required",
        "stage2Questions": "LTA price/volume flex vs take-or-pay? Memory cycle history vs HBM custom-design argument?",
        "status": "STAGE 2 PRIORITY #1"
      },
      {
        "ticker": "HPE", "name": "Hewlett Packard Enterprise", "priority": 2,
        "price": 26.44, "52wkHigh": 26.44, "drawdown": 0.0, "fwdPE": 10.74,
        "trigger": "SI-48 enables now OR -10% = $23.80",
        "thesisOneLine": "At ATH but fwd PE 10.74 (cheapest AI name); Juniper acquired, $5B AI backlog, $600M synergy target",
        "nextEarnings": "Early June 2026 Q2 FY26",
        "si48Status": "PASSES scan — cheap multiple + contracted backlog + earnings-growth-driven upside",
        "stage2Questions": "AI backlog customer composition? Juniper synergy timeline? Memory cost exposure?",
        "status": "STAGE 2 PRIORITY #2 — SI-48 enables entry at current levels pending verification"
      },
      {
        "ticker": "SNPS", "name": "Synopsys", "priority": 3,
        "price": 449.00, "52wkHigh": 651.73, "drawdown": -31.1, "fwdPE": 30.58,
        "trigger": "Already triggered — at -31%",
        "thesisOneLine": "EDA duopoly toll on all chip design (31% market share); China export shock selloff; structural 60% GM",
        "nextEarnings": "Mid-May 2026 approximate",
        "si48Status": "N/A — already drawn down, standard SI-39 trigger satisfied",
        "stage2Questions": "Ansys integration timeline? China revenue detail (~16%)? Fwd PE vs sustainable growth?",
        "status": "STAGE 2 PRIORITY #3"
      }
    ],
    "tier2Priorities": [
      {
        "ticker": "CRDO", "name": "Credo Technology", "priority": 4,
        "price": 159.70, "52wkHigh": 213.80, "drawdown": -25.3, "fwdPE": 32.47,
        "thesisOneLine": "AEC (Active Electrical Cable) pioneer, FY26 +170% growth, 4 hyperscaler customers >10%",
        "criticalRisk": "Top 10 customers = 90% of revenue, single customer 67% in FY25",
        "status": "STAGE 2 — size at SI-37 speculative cap given concentration risk"
      },
      {
        "ticker": "ENR.DE", "name": "Siemens Energy", "priority": 5,
        "price": "~€157.50", "52wkHigh": "TBD Stage 2", "fwdPE": "TBD Stage 2",
        "thesisOneLine": "EU grid/turbine at ~60% discount to GE Vernova P/E multiple; AI-linked demand replacing wind",
        "accessNote": "IBKR EU access approved 2026-03-26",
        "status": "STAGE 2 — size at half normal position for FX and less familiar market"
      },
      {
        "ticker": "MRCY", "name": "Mercury Systems", "priority": 6,
        "price": 84.45, "52wkHigh": 103.84, "drawdown": -18.7, "fwdPE": 56.50,
        "thesisOneLine": "Defense AI edge compute; overlaps Golden Dome thesis",
        "concern": "Fwd PE 56 needs Stage 2 validation — possible P13/PLTR trap",
        "status": "STAGE 2 — fwd PE concern"
      }
    ],
    "tier3Speculative": [
      {
        "ticker": "POET", "name": "POET Technologies", "priority": 7,
        "price": 7.23, "marketCap": "$1.1B", "drawdown": -23.2,
        "thesisOneLine": "Silicon photonics Optical Interposer — one of few public CPO pure-plays",
        "reality": "Pre-revenue (Q3 2025 revenue $298K, net loss $9.4M); $5.6M initial production orders",
        "cashRunway": ">$300M post recent raise, multi-year",
        "sizing": "SI-37 speculative cap, max $1,000 — pure optionality",
        "status": "STAGE 2 — binary outcome, only if speculative allocation available"
      }
    ],
    "doNotEnter": [
  ...
  "priceVerificationProtocol": {
    ...
    "stage2Required": "SI-44 reaffirmed S24 — scan-phase figures must be primary-source verified before recommendation"
  },
  "cDriveProtocol": {
  ...
  "standingInstructions": [
    ...
    {"id": 34, "title": "TRADE TRACKER UPDATE PROTOCOL", "body": "5 rows pending. See SI-7 I7 in LESSONS_LEARNED.md"},
    ...
    {"id": 44, "title": "SI-44: TWO-STAGE RESEARCH PROTOCOL", "body": "STAGE 1 = scan candidate only. All figures UNVERIFIED. STAGE 2 = mandatory before capital: primary-source verification. HARD RULE: No scan-phase figure may appear in a recommendation without primary source verification. REAFFIRMED S24 for AI thesis."},
  ...
  "watchlistUS": [
    {
      ...
      "currentPrice": 97.31, "52wkHigh": 134.12, "drawdown": -27.4,
      "note": "SI-41 FAIL: next earnings Jul 16 — outside 8-week window."
    },
    {
    ...
    },
    {
      ...
      "note": "Nuclear + Amazon PPA 1,920 MW. May 5 earnings = gate."
    },
    {
  ...
  "sessionNotes": [
    ...
    {"date": "2026-04-19", "note": "SESSION 24 SUPPLEMENTARY — AI INFRASTRUCTURE THESIS DEEP DIVE. Full Stage 1 research in research/AI_INFRASTRUCTURE_THESIS.md. Four bottlenecks identified: power equipment (tightest), cooling, networking, memory. Tier 1 Stage 2 priorities: MU (HBM supercycle, fwd PE 7.86 anomaly, Q2 EPS $12.20 vs $8.42 guide), HPE (fwd PE 10.74 cheapest AI name, Juniper + $5B AI backlog), SNPS (EDA duopoly -31% drawdown). NEW RULES: SI-48 (AI thesis ATH rule amendment — ATH permitted if Stage 2 shows upside without multiple expansion), T19 (ATH rule thesis-dependent), T20 (Next Nvidia framing correction — IP/tech at modest valuation not literal Nvidia), P19 (AI thesis crowded trade observation), S12 (thesis-dedicated research files). DO NOT ENTER list updated: SMCI (T8), CRWV (debt/concentration), PLTR (P6 governs). PLTR P6 lesson remains governing — no entry on narrative/multiple expansion theses. Journal v34 written. SI-48 currently passes for HPE and MU. Stage 2 priority order: MU → HPE → SNPS."}
  ]
};
    ...
    <div style={{ background: COLORS.bg, minHeight: "100vh", color: COLORS.text, fontFamily: "monospace", padding: 16, maxWidth: 1200, margin: "0 auto" }}>
      ...
      <div style={{ marginBottom: 16 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 8 }}>
          <div>
            <div style={{ fontSize: 18, fontWeight: 700, color: COLORS.textBright }}>CLAUDE FUND — JOURNAL v34</div>
        ...
        <div style={{ marginTop: 6, padding: "6px 10px", background: "rgba(163,113,247,0.1)", border: "1px solid rgba(163,113,247,0.3)", borderRadius: 4, fontSize: 11, color: COLORS.purple }}>
          🧠 NEW S24: AI INFRASTRUCTURE THESIS SCAN COMPLETE — Tier 1 Stage 2: MU, HPE, SNPS. See research/AI_INFRASTRUCTURE_THESIS.md. SI-48 active.
        </div>
      </div>
      ...
      {activeTab === "aiwatch" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <div className="card" style={{ borderColor: COLORS.purple, borderLeftWidth: 3 }}>
            <div style={{ fontWeight: 700, color: COLORS.purple, fontSize: 13, marginBottom: 6 }}>AI INFRASTRUCTURE THESIS WATCHLIST (NEW S24)</div>
            <div style={{ fontSize: 11, color: COLORS.textDim, lineHeight: 1.6 }}>
              Governed by SI-48 (ATH rule amendment). Stage 2 required before any entry. Full research: C:\Users\jcadb\claude-fund\research\AI_INFRASTRUCTURE_THESIS.md
            </div>
          </div>
          ...
          {data.si39TierTwoAIThesisWatchlist?.tier1Priorities?.map(w => (
            <div key={w.ticker} className="card" style={{ borderLeft: `3px solid ${COLORS.purple}` }}>
              ...
              <div style={{ fontSize: 10, color: COLORS.textDim }}><b>Stage 2 questions:</b> {w.stage2Questions}</div>
          ...
          <div style={{ fontWeight: 600, color: COLORS.yellow, fontSize: 12, marginTop: 8 }}>FAILS SI-48 (MULTIPLE EXPANSION REQUIRED)</div>
          ...
          <div className="card" style={{ marginTop: 8, background: "rgba(248,81,73,0.05)", borderColor: "rgba(248,81,73,0.3)" }}>
            <div style={{ fontSize: 11, color: COLORS.red }}>
              ⚠️ <b>Allocation concern:</b> {data.si39TierTwoAIThesisWatchlist?.speculativeAllocationConcern}
            </div>
          </div>
        </div>
      )}
      ...
      {activeTab === "instructions" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {data.standingInstructions?.map(ins => (
            <div key={ins.id} className="card" style={{ display: "flex", gap: 12, borderLeft: ins.id === 48 ? `3px solid ${COLORS.purple}` : ins.id === 47 ? `3px solid ${COLORS.red}` : ins.id === 44 ? `3px solid ${COLORS.blue}` : ins.id === 25 ? `3px solid ${COLORS.red}` : undefined }}>
              <div style={{ fontSize: 11, color: ins.id === 48 ? COLORS.purple : ins.id === 47 ? COLORS.red : ins.id >= 44 ? COLORS.blue : COLORS.accent, fontWeight: 700, minWidth: 28 }}>#{ins.id.toString().padStart(2,"0")}</div>
              <div>
                <div style={{ fontWeight: 600, color: ins.id === 48 ? COLORS.purple : ins.id === 47 ? COLORS.red : ins.id >= 44 ? COLORS.blue : COLORS.textBright, marginBottom: 4, fontSize: 12 }}>{ins.title}</div>
      ...
      <div style={{ marginTop: 24, paddingTop: 12, borderTop: `1px solid ${COLORS.border}`, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
        <span style={{ fontSize: 10, color: COLORS.textDim }}>JOURNAL v34 // SESSION 24 SUPP // {data.fund.account} // C DRIVE + RESEARCH DIR CONFIRMED</span>
