...
const INITIAL_STATE = {
  ...
  "fund": {
    ...
    "cashGBP": -1774,
    "cashBase": 29946,
    "lastUpdated": "2026-03-26 EOD",
    "note": "CCL sold +profit. AVAV filled @195.09. Daily +0.62%."
  },
  "thesis": {
    ...
    "keyDates": [
      {
        "date": "27 Mar",
        "event": "CCL Q1 Earnings pre-market — SOLD CCL ahead of earnings",
        "priority": "MONITOR"
      },
      {
        "date": "28-31 Mar",
        "event": "Trump 5-day pause expires — IAG re-entry window $10K reserved",
        "priority": "CRITICAL"
      },
      {
        "date": "End Mar",
        "event": "KTOS Orbit Technologies acquisition close",
        "priority": "HIGH"
      },
      {
        "date": "30 Mar",
        "event": "RR.L GTD expires — confirm fill or resubmit",
        "priority": "HIGH"
      },
      {
        "date": "06 May",
        "event": "R3NK Q1 Earnings",
        "priority": "HIGH"
      },
      {
        "date": "07 May",
  ...
  "positions": [
    ...
    },
    {
      ...
      "target": 311,
      "status": "FILLED TODAY",
      "note": "Filled Mar 26 market. Stop 65 GTC live. Thesis: Switchblade Iran. Earnings Jun 23."
    },
    {
      "ticker": "CODA",
    ...
    },
    {
      ...
      "target": 130,
      "status": "HOLD",
      "note": "Orbit acquisition closing end Mar. No stop set."
    },
    {
      "ticker": "LEU",
      "name": "Centrus Energy",
    ...
    },
    {
      ...
      "target": 18,
      "status": "STOP LIVE ⚠️",
      "note": "Stop .50 GTC. -11.2% unrealised. IBKR warning flag visible. 12% buffer to stop. May 18 Q1 earnings catalyst. Hold thesis."
    },
    {
      "ticker": "PDYN",
      ...
      "target": null,
      "status": "HOLD",
      "note": "No stop set — recommend GTC .00. SwarmOS HANGTIME contract. Revenue guidance 4-27M 2026."
    },
    {
      "ticker": "PLTR",
    ...
    },
    {
      ...
      "status": "HOLD",
      "cur": "EUR",
      "note": "Filled Mar 26. €6.68B backlog. May 6 earnings. Ceasefire noise causing weakness — thesis intact."
    },
    {
      "ticker": "RCL",
  ...
  "pendingOrders": [
    {
      ...
      "tif": "GTC",
      "status": "ACTIVE",
      "note": "Protective stop on new position."
    },
    {
      "ticker": "CCJ",
      "action": "BUY",
  ...
  "watchlistUS": [
    {
      ...
      "exchange": "OTC",
      "current": null,
      "entry": "Re-enter on oil spike 28-31 Mar when pause expires",
      "target": null,
      "status": "ACTIVE — $10K reserved",
      "thesis": "$10,000 reserved. Iran pause expires = oil spike = airline re-entry."
    },
    {
      "ticker": "BKSY",
  ...
  "watchlistEU": [
    {
      ...
      "cur": "EUR",
      "upside": 47,
      "thesis": "Leopard 2 transmissions + naval + Iran ME expansion. CEO flagged ME demand surge. 42% off highs.",
      "note": "PRIORITY 1 — Buy on EU access approval"
    },
    {
      "ticker": "HAG",
      "name": "Hensoldt AG",
    ...
    },
    {
      ...
      "cur": "EUR",
      "upside": 29,
      "thesis": "Digital defence + Michelangelo Dome air defence + doubles profits 2030. Barclays OW.",
      "note": "PRIORITY 3 — Barclays Overweight upgrade."
    },
    {
      "ticker": "HO",
      "name": "Thales SA",
